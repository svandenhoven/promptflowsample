...
example:
`docker run -p 8080:8080 -e MINDPARKEASTUS2_API_KEY=db365fdccec042ffaa29eeb8cbe96a9d -e PROMPTFLOW_WORKER_NUM=1 -e PROMPTFLOW_WORKER_THREADS=1 dag_flow_image`
